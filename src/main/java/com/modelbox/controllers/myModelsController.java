...
public class myModelsController {
    ...
    public void addMyModelsPreviewCard(File modelFile) {
        ...
        previewModelBtn.setOnAction(e -> {
            ...
            // Set the id of the previewModelAnchorPane to be equal to the modelName
            ...
            // Add the mesh to the preview pop-up group for manipulation
            loginController.dashboard.previewPopUpView.previewModelGroup.getChildren().add(currentModelMeshView);

            // FIXME: Make the model so that it can be manipulated in 3D space
            // Position the model in the center of the model anchor pane
            loginController.dashboard.previewPopUpView.previewModelGroup.setTranslateX(
                    loginController.dashboard.previewPopUpView.previewModelAnchorPane.getWidth());
            loginController.dashboard.previewPopUpView.previewModelGroup.setTranslateY(
                    loginController.dashboard.previewPopUpView.previewModelAnchorPane.getHeight());
